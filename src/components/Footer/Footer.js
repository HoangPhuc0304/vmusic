...
import { imageSeason } from '../../fakeAPI/images/imageChart'
      ...
      <div className="footer-top">
        ...
        <div className="footer-top-item">
          ...
          <div className="footer-follow-list">
            <a href="https://www.facebook.com/" className="ti-facebook" target="_blank"></a>
            <a href="https://www.instagram.com/" className="ti-instagram" target="_blank"></a>
            <a href="https://www.apple.com/" className="ti-apple" target="_blank"></a>
            <a href="https://twitter.com/" className="ti-twitter-alt" target="_blank"></a>
          </div>
        </div>
        <div className="footer-top-item">
          <img src={photoSeason.link} alt="Photo Season" className='footer-season-photo'/>
        </div>
      </div>
      <div className="footer-bottom">
        <div className="footer-bottom-menu">
          <a href="" target="_blank">Legal</a>
          <a href="" target="_blank">Privacy Center</a>
        ...
        <div className="footer-bottom-copyright">
          <div className="footer-country">
            ...
            <a href="https://vi.wikipedia.org/wiki/Vi%E1%BB%87t_Nam" target="_blank">Vietnam</a>
          </div>
